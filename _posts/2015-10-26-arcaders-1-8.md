...
![Furthest background](/images/starBG.png)

![Closest background](/images/starMG.png)

![Foreground](/images/starFG.png)
...
Well, that was short an sweet, wasn't it! [Next time](#), we're going to do
something a bit different: we'll take a break from our game's logic and add a
main menu to our game.
