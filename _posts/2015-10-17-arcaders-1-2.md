...
If you `build` this code right now, you will probably not see any difference.
...
In other words, the compiler ensures that it will _just work<sup>TM</sup>_. This
