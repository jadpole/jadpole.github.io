...
[development libraries](https://www.libsdl.org/projects/SDL_image), like you did
previously with SDL2.
...
where F: Fn(&mut Phi) -> Box<View> {
    ...
    // Initialize plugins
    let image = ::sdl2_image::init(::sdl2_image::INIT_PNG).unwrap();
...
method which we will call `new`. This will be the occasion to take a look at
